...
class ChatBotModel(AzureaiLlmModel):    
    ...
    def __init__(self):
        ...
        self.criteria_path = r'app\data\Criterios\CRITERIOS_FINAL.xlsm'
        self.current_cf = self.load_criteria_from_excel_()
        
        os.makedirs(self.parquet_data_folder_path, exist_ok=True)
    ...
    def load_criteria_from_excel_(self):
        try:
            ...
            cf = cf[['EQUIPO', 'MEJOR ESCENARIO', 'DÍA RECOMENDADO', 'COMENTARIO'] + [f'RESTRICCIÓN {i}' for i in range(1,16)]]
