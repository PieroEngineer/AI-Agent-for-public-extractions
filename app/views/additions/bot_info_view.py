...
class BotInfoLoader(QLabel):
    def __init__(self, parent=None):
        super().__init__("😁 Bienvenid@s!! Soy el robot buscador y estoy listo para ayudarte", parent)
    ...
    def stop_last_process(self):
        if self.timer.isActive():
            self.timer.stop()
            self.setText('😁 Bienvenid@s!! Soy el robot buscador y estoy listo para ayudarte')