...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.logo_label.setPixmap(QPixmap(r"app\resources\images\Logo.png").scaled(259, 120, Qt.AspectRatioMode.KeepAspectRatio))
        self.main_layout.addWidget(self.logo_label)

        # Top info chat
        self.bot_info_label = BotInfoLoader()
        self.bot_info_label.setText('😁 Bienvenidos!! Soy el robot buscador y estoy listo para ayudarte')
