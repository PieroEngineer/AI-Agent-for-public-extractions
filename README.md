...
- app/models/Business_chatbot_model.py — domain logic, data fetching and parsing
...
- To add tools or data processing, extend `BusinessChatBotModel.find_data_()` and related helper methods.
